...
namespace Polarities.Content.NPCs.Bosses.Hardmode.Eclipxie
{
    ...
    {
        public override string Texture => "Polarities/Assets/WarpZoom256";
    ...
    public class EclipxieRaysBig : ModProjectile
    {
        ...
        public override string Texture => "Polarities/Content/NPCs/Bosses/Hardmode/Eclipxie/EclipxieRay";
