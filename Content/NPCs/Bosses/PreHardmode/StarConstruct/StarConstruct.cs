...
namespace Polarities.Content.NPCs.Bosses.PreHardmode.StarConstruct
{
    [AutoloadBossHead]
    public class StarConstruct : ModNPC
    {
        ...
        {
            LegTexture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/PreHardmode/StarConstruct/StarConstructLeg");
            ChainTexture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/PreHardmode/StarConstruct/StarConstructChain");
            ClawTexture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/PreHardmode/StarConstruct/StarConstructClaw");
            DashTexture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/PreHardmode/StarConstruct/StarConstructDash");
        ...
        public override void SetDefaults()
        {
            ...
            Music = MusicLoader.GetMusicSlot(Mod, "Assets/Sounds/Music/StarConstruct");
        ...
        {
            npcLoot.Add(new FlawlessOrRandomDropRule(ItemType<StarConstructTrophy>(), 10));
            npcLoot.Add(ItemDropRule.BossBag(ItemType<StarConstructBag>()));
            npcLoot.Add(ItemDropRule.MasterModeCommonDrop(ItemType<StarConstructRelic>()));
            npcLoot.Add(ModUtils.MasterModeDropOnAllPlayersOrFlawless(ItemType<StarConstructPetItem>(), 4));

            //normal mode loot
            LeadingConditionRule notExpertRule = new LeadingConditionRule(new Conditions.NotExpert());
            notExpertRule.OnSuccess(ItemDropRule.Common(ItemType<StarConstructMask>(), 7));
            notExpertRule.OnSuccess(ItemDropRule.Common(ItemID.SkyMill));
            notExpertRule.OnSuccess(ItemDropRule.Common(ItemType<SunplateBar>(), minimumDropped: 12, maximumDropped: 20));
            notExpertRule.OnSuccess(ItemDropRule.OneFromOptionsNotScalingWithLuck(1, ItemType<Starhook>(), ItemType<StarBadge>(), ItemType<StrangeClock>()));
            npcLoot.Add(notExpertRule);

            npcLoot.Add(ItemDropRule.ByCondition(new FlawlessDropCondition(), ItemType<Stardance>()));
        }
    }
    ...
    internal class DormantConstruct : ModNPC
    {
        ...
        public override void Load()
        {
            LegTexture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/PreHardmode/StarConstruct/DormantConstructLeg");
        }
