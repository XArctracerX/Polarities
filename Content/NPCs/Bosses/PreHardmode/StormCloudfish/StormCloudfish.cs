...
namespace Polarities.Content.NPCs.Bosses.PreHardmode.StormCloudfish
{
    [AutoloadBossHead]
    public class StormCloudfish : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            Music = MusicLoader.GetMusicSlot(Mod, "Assets/Sounds/Music/StormCloudfish");
        ...
        public override bool CheckDead()
        {
            ...
            {
                Main.npc[NPC.NewNPC(NPC.GetSource_Death(), (int)NPC.Center.X + Main.rand.Next(-NPC.width / 4, NPC.width / 4), (int)NPC.Center.Y + Main.rand.Next(-NPC.height / 4, NPC.height / 4), NPCType<Content.NPCs.Critters.PreHardmode.StormcloudCichlid>())].velocity = new Vector2(Main.rand.NextFloat(-2f, 2f), Main.rand.NextFloat(-2f, 2f));
            }
            for (int i = 0; i < 40; i++)
            {
