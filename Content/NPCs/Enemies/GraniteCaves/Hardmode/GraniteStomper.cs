...
namespace Polarities.Content.NPCs.Enemies.GraniteCaves.Hardmode
{
    ...
    {
        public override string Texture => "Polarities/Content/Items/Materials/PreHardmode/BlueQuartz";
