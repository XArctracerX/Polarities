...
namespace Polarities.Content.NPCs.Enemies.HallowInvasion
{
    public class SunServitor : ModNPC
    {
        ...
        private void Teleport()
        {
            for (int a = 0; a < 12; a++)
            {
                Dust.NewDustDirect(NPC.position, NPC.width, NPC.height, DustID.Torch, newColor: Color.White, Scale: 1.4f).noGravity = true;
            }
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            {
                return Content.Events.HallowInvasion.GetSpawnChance(2);
            }
            return 0f;
        }
    }
