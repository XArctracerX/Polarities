...
using Polarities.Content.Items.Weapons.Summon.Sentries.Hardmode;
...
namespace Polarities.Content.NPCs.Enemies.HallowInvasion
{
    public class IlluminantScourer : ModNPC
    {
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            {
                return ModUtils.Lerp(Content.Events.HallowInvasion.GetSpawnChance(0), Content.Events.HallowInvasion.GetSpawnChance(1), 0.66f);
            }
            return 0f;
        }
    }
