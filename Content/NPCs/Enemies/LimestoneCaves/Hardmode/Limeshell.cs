...
namespace Polarities.Content.NPCs.Enemies.LimestoneCaves.Hardmode
{
    public class Limeshell : ModNPC
    {
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ItemType<Content.Items.Placeable.Blocks.Limestone>(), 1, 5, 10));
    ...
    {
        public override string Texture => "Polarities/Content/Items/Weapons/Ranged/Bows/PreHardmode/AlkalineRainProjectile";
