...
namespace Polarities.Content.NPCs.Enemies.LimestoneCaves.PreHardmode
{
    public class GlowWorm : ModNPC
    {
        ...
        {
            public override string Texture => "Polarities/Content/Items/Weapons/Melee/Yoyos/PreHardmode/GlowYoDroplet";
            ...
            {
                target.AddBuff(BuffType<Corroding>(), 15 * 60);
            }
        }
    }
}