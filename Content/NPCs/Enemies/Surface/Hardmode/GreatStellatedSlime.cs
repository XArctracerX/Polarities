...
using Polarities.Content.Items.Accessories.Combat.Mixed.Hardmode;
...
namespace Polarities.Content.NPCs.Enemies.Surface.Hardmode
{
    public class GreatStellatedSlime : ModNPC
    {
        ...
        {
            npcLoot.Add(ItemDropRule.NormalvsExpert(ItemType<StargelAmulet>(), 2, 1));
