...
namespace Polarities.Content.NPCs.Critters.Hardmode
{
    public class BabyWanderer : ModNPC
    {
        ...
        public override bool CheckDead()
        {
            ...
            if (!NPC.AnyNPCs(NPCType<ConvectiveWanderer>()) && Main.LocalPlayer.InModBiome(GetInstance<LavaOcean>()) && PolaritiesSystem.convectiveWandererSpawnTimer == 0) PolaritiesSystem.convectiveWandererSpawnTimer = 1;
            return true;
        }
    ...
    {
        public override string Texture => "Polarities/Content/NPCs/Critters/Hardmode/BabyWanderer";
