...
namespace Polarities.Content.Events
{
    ...
    public class WorldEvilInvasion : ModBiome
    {
        ...
        public override int Music => MusicLoader.GetMusicSlot(Mod, "Assets/Sounds/Music/Pestilence");
    ...
    public class WorldEvilInvasionSky : CustomSky, ILoadable
    {
        ...
        public void Load(Mod mod)
        {
            ...
            BGDust = Request<Texture2D>("Polarities/Content/Events/WorldEvilInvasionSky_BGDust");
        }
