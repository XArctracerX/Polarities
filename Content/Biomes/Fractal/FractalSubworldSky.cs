    ...
    public class FractalSubworldSky : CustomSky
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            if (Main.BackgroundEnabled)
            {
                ...
                DrawFractalBackgroundTexture(spriteBatch, ModContent.Request<Texture2D>("Polarities/Content/Biomes/Fractal/FractalBackgroundFar").Value, 0.05f, 0.04f, backgroundAlpha[DefaultBackground] + backgroundAlpha[OceanBackground]);
                DrawFractalBackgroundTexture(spriteBatch, ModContent.Request<Texture2D>("Polarities/Content/Biomes/Fractal/FractalBackgroundMid").Value, 0.1f, 0.08f, backgroundAlpha[DefaultBackground] + backgroundAlpha[OceanBackground]);
                DrawFractalBackgroundTexture(spriteBatch, ModContent.Request<Texture2D>("Polarities/Content/Biomes/Fractal/FractalBackgroundClose").Value, 0.15f, 0.12f, backgroundAlpha[DefaultBackground]);
                DrawFractalBackgroundTexture(spriteBatch, ModContent.Request<Texture2D>("Polarities/Content/Biomes/Fractal/FractalOceanBackgroundClose").Value, 0.15f, 0.12f, backgroundAlpha[OceanBackground]);
            }
            ...
            if (backgroundAlpha[DefaultBackground] > 0)
            {
                ...
                for (int j = 0; j < maxClouds; j++)
                {
                    ...
                    Texture2D cloudTexture = ModContent.Request<Texture2D>("Polarities/Content/Biomes/Fractal/notcloud_" + (int)Math.Max(clouds[i, 4], 1)).Value;
                    Vector2 drawPos = new Vector2(clouds[i, 0], clouds[i, 1]) + Main.screenPosition * clouds[i, 2] - Main.screenPosition;
            ...
            if (backgroundAlpha[OceanBackground] > 0)
            {
                ...
                for (int j = 0; j < maxBubbles; j++)
                {
                    ...
                    Texture2D bubbleTexture = ModContent.Request<Texture2D>("Polarities/Content/Biomes/Fractal/bobble_" + (int)bubbles[i, 4]).Value;
                    Vector2 drawPos = new Vector2(bubbles[i, 0], bubbles[i, 1]) + Main.screenPosition * bubbles[i, 2] - Main.screenPosition;
