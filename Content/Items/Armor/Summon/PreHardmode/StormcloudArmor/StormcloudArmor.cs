...
namespace Polarities.Content.Items.Armor.Summon.PreHardmode.StormcloudArmor
{
    ...
    public class StormcloudMask : ModItem
    {
        ...
        {
            player.setBonus = Language.GetTextValue("Mods.Polarities.ArmorSetBonus.Stormcloud.Description");
            player.maxMinions += 1;
    ...
    {
        public override string Texture => "Polarities/Content/NPCs/Bosses/PreHardmode/StormCloudfish/StormCloudfishRaincloud";
