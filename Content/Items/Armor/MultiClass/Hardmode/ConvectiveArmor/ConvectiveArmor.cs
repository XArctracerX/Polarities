...
namespace Polarities.Content.Items.Armor.MultiClass.Hardmode.ConvectiveArmor
{
    ...
    public class ConvectiveHelmetMelee : ModItem, IDrawArmor
    {
        ...
        public override void UpdateArmorSet(Player player)
        {
            ...
            player.setBonus = Language.GetTextValueWith("Mods.Polarities.ArmorSetBonus.Convective.Melee", new { Hotkey = hotkey });
    ...
    public class ConvectiveHelmetRanged : ModItem, IDrawArmor
    {
        ...
        {
            string hotkey = Polarities.ArmorSetBonusHotkey.GetAssignedKeys().ToArray().Length > 0 ? Polarities.ArmorSetBonusHotkey.GetAssignedKeys()[0] : Language.GetTextValue("Mods.Polarities.Misc.UnboundHotkey");
            player.setBonus = Language.GetTextValueWith("Mods.Polarities.ArmorSetBonus.Convective.Ranged", new { Hotkey = hotkey });
    ...
    public class ConvectiveHelmetMagic : ModItem, IDrawArmor
    {
        ...
        {
            string hotkey = Polarities.ArmorSetBonusHotkey.GetAssignedKeys().ToArray().Length > 0 ? Polarities.ArmorSetBonusHotkey.GetAssignedKeys()[0] : Language.GetTextValue("Mods.Polarities.Misc.UnboundHotkey");
            player.setBonus = Language.GetTextValueWith("Mods.Polarities.ArmorSetBonus.Convective.Magic", new { Hotkey = hotkey });
    ...
    {
        public override string Texture => "Polarities/Content/NPCs/Bosses/Hardmode/ConvectiveWanderer/ConvectiveWandererHeatVortex";
