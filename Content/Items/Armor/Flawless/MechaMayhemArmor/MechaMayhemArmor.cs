...
namespace Polarities.Content.Items.Armor.Flawless.MechaMayhemArmor
{
    ...
    public class FlawlessMechMask : ModItem, IDrawArmor
    {
        ...
        {
            player.setBonus = Language.GetTextValue("Mods.Polarities.ArmorSetBonus.MechaMayhem.Description");
