...
namespace Polarities.Content.Items.Armor.Classless.Hardmode.SnakescaleArmor
{
    ...
    public class SnakescaleMask : ModItem
    {
        ...
        {
            player.setBonus = Language.GetTextValue("Mods.Polarities.ArmorSetBonus.Snakescale.Description");
