...
namespace Polarities.Content.Items.Armor.Classless.Hardmode.LimestoneArmor
{
    ...
    public class LimestoneHelmet : ModItem, IDrawArmor
    {
        ...
        {
            player.setBonus = Language.GetTextValue("Mods.Polarities.ArmorSetBonus.Limestone.Description");
