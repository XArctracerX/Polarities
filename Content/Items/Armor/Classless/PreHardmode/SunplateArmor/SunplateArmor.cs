...
namespace Polarities.Content.Items.Armor.Classless.PreHardmode.SunplateArmor
{
    ...
    public class SunplateMask : ModItem
    {
        ...
        {
            player.setBonus = Language.GetTextValue("Mods.Polarities.ArmorSetBonus.Sunplate.Description");
