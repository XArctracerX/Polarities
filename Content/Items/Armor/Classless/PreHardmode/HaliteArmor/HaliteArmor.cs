...
namespace Polarities.Content.Items.Armor.Classless.PreHardmode.HaliteArmor
{
    ...
    public class HaliteHelmet : ModItem
    {
        ...
        {
            player.setBonus = Language.GetTextValue("Mods.Polarities.ArmorSetBonus.Halite.Description");
