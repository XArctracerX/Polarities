...
{
	public class PolarPickaxe : ModItem
	{
		...
		public override void UpdateInventory(Player player)
		{
			if (player.HeldItem == Item)
			{
				...
				{
					if (i.DistanceSQ(player.position) <= 625 * 64) Dust.NewDustDirect(i.position, i.width, i.height, DustID.Electric, Scale: 0.5f).noGravity = true;
