...
namespace Polarities.Content.Items.Tools.Hooks.Hardmode
{
    internal class HemolyticHook : ModItem
    {
        public override void SetStaticDefaults()
        {
            //DisplayName.SetDefault("Hemolytic Hook");
            //Tooltip.SetDefault("Grants a small amount of defense for each attached hook");
        ...
        {
            CreateRecipe()
                .AddIngredient(ItemType<PhagefootHook>())
                .AddIngredient(ItemType<HemorrhagicFluid>(), 10)
                .AddTile(TileID.MythrilAnvil)
                .Register();
        }
    }

    internal class HemolyticHookProjectile : ModProjectile
    {
        public override string Texture => "Polarities/Content/NPCs/Bosses/Hardmode/Hemorrphage/HemorrphageLeg";
        ...
        {
            Texture2D chainTexture = HemorrphageLeg.ChainTexture.Value;
            Rectangle chainFrame = HemorrphageLeg.ChainTexture.Frame();
