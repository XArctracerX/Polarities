...
using Polarities.Content.Items.Consumables.Keys.Hardmode;
using Terraria;
...
namespace Polarities.Content.Items.Placeable.Furniture.Fractal
{
    ...
    public class FractalChestTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            // Properties
            ...
            RegisterItemDrop(ModContent.ItemType<FractalChest>(), 1);
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            else
            {
                if (isLocked)
                {
                    int key = ModContent.ItemType<FractalKey>();
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<FractalChest>();
                    if (Main.tile[left, top].TileFrameX / 36 == 1)
                        player.cursorItemIconID = ModContent.ItemType<FractalKey>();
