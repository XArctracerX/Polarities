...
namespace Polarities.Content.Items.Placeable.Relics
{
    ...
    public class RiftDenizenRelicTopperTile : ModTile
    {
        ...
        public virtual string RelicTextureName => "Polarities/Content/Items/Placeable/Relics/RiftDenizenRelicTopperTile";
