...
namespace Polarities.Content.Items.Placeable.Relics
{
    ...
    public class SelfsimilarSentinelRelicTopperTile : ModTile
    {
        ...
        public virtual string RelicTextureName => "Polarities/Content/Items/Placeable/Relics/SelfsimilarSentinelRelicTopperTile";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "Polarities/Content/Items/Placeable/Relics/RelicTile";
