...
namespace Polarities.Content.Items.Placeable.Relics
{
    ...
    public class HemorrphageRelicTopperTile : ModTile
    {
        ...
        public virtual string RelicTextureName => "Polarities/Content/Items/Placeable/Relics/HemorrphageRelicTopperTile";
