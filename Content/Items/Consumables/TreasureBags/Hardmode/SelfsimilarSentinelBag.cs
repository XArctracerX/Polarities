...
{
	public class SelfsimilarSentinelBag : ModItem
	{
        ...
        {
            itemLoot.Add(ItemDropRule.NotScalingWithLuck(ItemType<SelfsimilarSentinelMask>(), 7));
            itemLoot.Add(ItemDropRule.NotScalingWithLuck(ItemType<SelfsimilarOre>(), 1, 50, 80));
            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(NPCType<SelfsimilarSentinel>()));
        }
