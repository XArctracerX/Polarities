...
{
    public class EclipxieBag : ModItem
    {
        ...
        {
            itemLoot.Add(ItemDropRule.NotScalingWithLuck(ItemType<SolarCalibrator>(), 1));
            itemLoot.Add(ItemDropRule.NotScalingWithLuck(ItemType<EclipxieMask>(), 7));
            itemLoot.Add(ItemDropRule.NotScalingWithLuck(ItemType<EclipxieDust>(), 1, 15, 25));
            itemLoot.Add(ItemDropRule.OneFromOptionsNotScalingWithLuck(1, ItemType<BlackLight>(), ItemType<SolarEyeStaff>(), ItemType<Sunsliver>(), ItemType<MoonDisc>(), ItemType<SunDisc>()));
            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(NPCType<Eclipxie>()));
        }
