...
{
    public class HemorrphageBag : ModItem
    {
        ...
        {
            itemLoot.Add(ItemDropRule.NotScalingWithLuck(ItemType<BloodBearer>(), 1));
            itemLoot.Add(ItemDropRule.Common(ItemType<HemorrphageMask>(), 7));
            itemLoot.Add(ItemDropRule.Common(ItemType<VolatileHeart>(), 4));
            itemLoot.Add(ItemDropRule.OneFromOptionsNotScalingWithLuck(1, ItemType<BleedingSky>(), ItemType<BloodDicer>(), ItemType<Hemophobia>(), ItemType<Phagocyte>()));
            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(NPCType<Hemorrphage>()));
        }
