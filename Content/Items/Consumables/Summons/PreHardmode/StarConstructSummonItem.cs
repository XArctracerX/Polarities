...
namespace Polarities.Content.Items.Consumables.Summons.PreHardmode
{
    public class StarConstructSummonItem : ModItem
    {
        ...
        public override bool? UseItem(Player player)
        {
            ...
            Main.npc[NPC.NewNPC(new EntitySource_BossSpawn(player), (int)player.Center.X + Main.rand.Next(-500, 500), (int)player.position.Y - 1000, NPCType<DormantConstruct>())].netUpdate = true;
            return true;
        }
