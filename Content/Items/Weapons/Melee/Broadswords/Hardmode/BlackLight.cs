...
namespace Polarities.Content.Items.Weapons.Melee.Broadswords.Hardmode
{
    public class BlackLight : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ProjectileType<BlackLightProjectile>();
            Item.shootSpeed = 1f;
        }
    ...
    public class BlackLightProjectile : ModProjectile
    {
        public override string Texture => "Polarities/Content/Items/Weapons/Melee/Broadswords/Hardmode/BlackLight";
        ...
        public override void AI()
        {
            ...
            Projectile.rotation += Projectile.ai[1] * sinScale / Projectile.ai[0] * MathHelper.Pi * (timer++ > 60 ? -1 : 1);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            while ((drawCurrentSegmentPos - goalPos).Length() > segmentLength && steps < 800)
            {
                ...
                for (int i = 0; i < numLayers; i++)
                {
                    ...
                    Color color = new Color((int)(100 * colorAmount + 255 * (1 - colorAmount)), (int)(0 * colorAmount + 255 * (1 - colorAmount)), (int)(200 * colorAmount + 255 * (1 - colorAmount)));
