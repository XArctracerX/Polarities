...
namespace Polarities.Content.Items.Weapons.Melee.Spears.Hardmode
{
    public class Preserver : ModItem
    {
        ...
        {
            CreateRecipe()
                .AddIngredient(ItemType<CongealedBrine>(), 5)
                .AddIngredient(ItemType<SaltCrystals>(), 10)
    ...
    public class PreserverProjectile : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            target.AddBuff(BuffType<ToxicShock>(), 15);
        }
