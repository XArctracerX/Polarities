...
namespace Polarities.Content.Items.Weapons.Melee.Warhammers.Hardmode.Other
{
    public class TentacleClub : WarhammerBase
    {
        ...
        public override bool? UseItem(Player player)
        {
            if (player.altFunctionUse == 2)
            {
                ...
                Item.shoot = ModContent.ProjectileType<TentacleClubProjectile>();
                Item.shootSpeed = 16f;
                Item.noMelee = true;
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<Tentacle>(), 4)
    ...
    {
        public override string Texture => "Polarities/Content/Items/Weapons/Melee/Warhammers/Hardmode/Other/TentacleClub";
