...
using Polarities.Content.Items.Weapons.Melee.Warhammers.PreHardmode.Metal;
using System;
...
namespace Polarities.Content.Items.Weapons.Melee.Warhammers.Hardmode.Metal
{
    ...
    {
        public override string Texture => "Polarities/Content/Items/Weapons/Melee/Warhammers/Hardmode/Metal/SeismicStriker";
