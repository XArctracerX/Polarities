...
namespace Polarities.Content.Items.Weapons.Magic.Staffs.Hardmode
{
    public class SeepingDeath : ModItem
    {
        ...
        {
            CreateRecipe()
                .AddIngredient(ItemType<CongealedBrine>(), 6)
    ...
    public class SeepingDeathProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Main.dust[Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustType<SaltWaterSplash>(), Scale: 1f)].noGravity = true;
        }
        ...
        {
            target.AddBuff(BuffType<Desiccating>(), 60);
        }
