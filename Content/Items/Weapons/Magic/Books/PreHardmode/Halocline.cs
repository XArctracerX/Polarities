...
namespace Polarities.Content.Items.Weapons.Magic.Books.PreHardmode
{
    ...
    public class HaloclineBubbleLarge : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                Main.dust[Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustType<SaltWaterSplash>(), Scale: 1.5f)].noGravity = true;
            }
        }
    ...
    public class HaloclineBubbleSmall : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Main.dust[Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustType<SaltWaterSplash>(), Scale: 1.5f * Projectile.scale)].noGravity = true;
        }
