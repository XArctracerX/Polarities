...
namespace Polarities.Content.Items.Weapons.Summon.Sentries.Hardmode
{
    ...
    {
        public override string Texture => "Polarities/Content/NPCs/Enemies/HallowInvasion/IlluminantScourer";
    ...
    {
        public override string Texture => "Polarities/Content/NPCs/Enemies/HallowInvasion/IlluminantScourerLaser";
