...
namespace Polarities
{
    public class Sounds : ILoadable
    {
        ...
        {
            Rattle = new SoundStyle("Polarities/Assets/Sounds/Rattle") { Volume = 0.7f, PitchVariance = 0.5f };

            ConvectiveWandererRoar = new SoundStyle("Polarities/Assets/Sounds/ConvectiveWandererRoar");
            ConvectiveBabyDeath = new SoundStyle("Polarities/Assets/Sounds/ConvectiveBabyDeath");
            ConvectiveWandererFlamethrowerStart = new SoundStyle("Polarities/Assets/Sounds/ConvectiveWandererFlamethrowerStart");
            ConvectiveFlamePillar = new SoundStyle("Polarities/Assets/Sounds/ConvectiveFlamePillar");
            ConvectiveProjectileFire = new SoundStyle("Polarities/Assets/Sounds/ConvectiveProjectileFire");
            ConvectiveBoom = new SoundStyle("Polarities/Assets/Sounds/ConvectiveBoom");
            ConvectiveClap = new SoundStyle("Polarities/Assets/Sounds/ConvectiveClap");
            ConvectiveDrill = new SoundStyle("Polarities/Assets/Sounds/ConvectiveDrill");
            ConvectiveMegaBoom = new SoundStyle("Polarities/Assets/Sounds/ConvectiveMegaBoom");
            ConvectiveOrbCharge = new SoundStyle("Polarities/Assets/Sounds/ConvectiveOrbCharge");
            ConvectiveHitHead = new SoundStyle("Polarities/Assets/Sounds/ConvectiveHitHead") { MaxInstances = 1, SoundLimitBehavior = SoundLimitBehavior.IgnoreNew };

            StarConstructScream = new SoundStyle("Polarities/Assets/Sounds/StarConstructScream");
            StarConstructRoar = new SoundStyle("Polarities/Assets/Sounds/StarConstructRoar");

            Bonk = new SoundStyle("Polarities/Assets/Sounds/Bonk");

            //sound loops
            ConvectiveWandererFlamethrowerLoop = new LoopedSound(new SoundStyle("Polarities/Assets/Sounds/ConvectiveWandererFlamethrowerLoop"));
        }
